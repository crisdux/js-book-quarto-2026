...
`parseInt` toma los valores válidos de izquierda a derecha, dicho esto, solo tomará el valor `7` (el `*` y todo lo que le precede no es un valor válido para `parseInt`).
