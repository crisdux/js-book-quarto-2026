...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, opacityback=0, colframe=quarto-callout-caution-color-frame, leftrule=.75mm, bottomrule=.15mm, breakable, bottomtitle=1mm, colback=white, left=2mm, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Dificultad}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, bottomrule=.15mm, breakable, bottomtitle=1mm, colback=white, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Pista}, arc=.35mm]
