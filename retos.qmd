...
## Reto #46: Quiero pizza {#sec-array-46}
...
## Reto #50: Parámetros REST en funciones modernas {#sec-array-50}
...
## Reto #53: Cuidado con el return implícito de las funciones {#sec-array-53}
...
## Reto #83: `var`, `let`, `const` y el alcance global {#sec-array-83}
...
## Reto #86: Interpolación de cadenas clásico {#sec-array-86}
...
## Reto #87: Desestructuración de arreglos y `length` {#sec-array-87}
...
## Reto #88: `forEach` y `console.count` {#sec-array-88}
...
## Reto #89: Nuavamente la Temporal Dead Zone {#sec-array-89}
...
## Reto #90: Conociendo `at` {#sec-array-90}
...
## Reto #91: Verificar si un arreglo esta vacío {#sec-array-91}
...
## Reto #92: `JSON.stringify` para convertir objetos a cadenas{#sec-array-92}
...
## Reto #93: ¿Suma de arreglos? {#sec-array-93}
...
**Pista:** Cuidado con el operador `+`, especialmente cuando se usan arreglos.
...
## Reto #94: Comparación de `NaN` con `Object.is` {#sec-array-94}
...
## Reto #95: Trabajando con `undefined` {#sec-array-95}
...
**[Ver solución](#sec-sol-array-95)**

---

## Reto #96: El objeto `Error` {#sec-array-96}
...
**[Ver solución](#sec-sol-array-96)**

---

## Reto #97: Convirtiendo valores a booleanos {#sec-array-97}
...
**[Ver solución](#sec-sol-array-97)**

---

## Reto #98: {#sec-array-98}
...
**[Ver solución](#sec-sol-array-98)**

---

## Challenge #98: El tipo `Symbol` como llaves de objetos {#sec-array-98-en}
...
**Hint:** Los valores `Symbol` son únicos en un programa, muy útiles para crear propiedades privadas en objetos.
...
**[See solution](#sec-sol-array-98)**

---

## Reto #99: Operadores de corto circuito {#sec-array-99}
...
**[Ver solución](#sec-sol-array-99)**

---

## Reto #100: Redondeo de números con el objeto `Math`{#sec-array-100}
...
**[Ver solución](#sec-sol-array-100)**
