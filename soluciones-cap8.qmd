...
Para comprender la respuesta es necesario entender temas estructurales del lenjuage, es decir, ir a las bases de JavaScript y conocer conceptos como [Event Loop](#glos-event_loop), [Call Stack](#glos-call_stack), [Task Queue](#glos-task_queue), [Web API's](#glos-web_apis) entre otros. 
