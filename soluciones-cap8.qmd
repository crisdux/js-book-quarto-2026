...
Para comprender la respuesta es necesario entender temas estructurales del lenguaje, es decir, ir a las bases de JavaScript y conocer conceptos como [Event Loop](#glos-event_loop), [Call Stack](#glos-call_stack), [Task Queue](#glos-task_queue), [Web API's](#glos-web_apis) entre otros. 
...
Ahora, el algoritmo del **Event Loop** se da cuenta que no hay más funciones por llamar, y verifica que el **Call Stack** está vacío, entonces busca si hay algo en el **Task Queue**, y oh sorpresa, está nuestro `setTimeout`, entonces lo pasa al **Call Stack** para finalmente mostrar por consola `Second`
...
## Reto 8.2 {#sec-sol-cap8-reto2}

La respuesta del [Reto 8.2](#sec-cap8-reto2) es:
...
## Reto 8.3 {#sec-sol-cap8-reto3}

La respuesta del [Reto 8.3](#sec-cap8-reto3) es:

**C. `Promise {<pending>}`**

**Explicación:**

Una función asíncrona siempre regresa una [promesa](#glos-promesa) pero dicha promesa no basta con ser devuelta sino que debe ser consumida, una posible solución es usar las palabras reservadas `then` y `catch`.
...
## Reto 8.4 {#sec-sol-cap8-reto4}

La respuesta del [Reto 8.4](#sec-cap8-reto4) es:
